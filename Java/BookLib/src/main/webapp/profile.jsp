...
<%@ page import="java.util.ArrayList, classFile.objClass, jakarta.servlet.http.HttpSession" %>
...
<style>
    *{
    ...
    <header id="header" >
        ...
        <form action="search?val=uprof" id="form" method="get"> <input type="search" id="sea" name="bkname" placeholder="search.."><button type="submit">search</button> </form>
    </header>
    <div id="userdetail">
        ...
        <table id="tab">
            ...
            <tr><td><label>User Name : </label></td><td><input type="text" value="<%=uname %>" name="username"></td></tr>
            <tr><td><label>Password &nbsp; : </label></td><td><input type="text" value="<%=psw %>" name="userpassword"></td></tr>
